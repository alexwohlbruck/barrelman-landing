...
const _lazy_FivufN = () => import('../routes/api/demo/_group_.get.mjs');
const _lazy_jeYEzU = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/demo/:group', handler: _lazy_FivufN, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_jeYEzU, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_jeYEzU, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, withoutTrailingSlash as A, handler as B, getQuery as a, getRequestHeader as b, createError$1 as c, defineEventHandler as d, getRequestIP as e, encodePath as f, getRouterParam as g, defineRenderHandler as h, destr as i, joinRelativeURL as j, getRouteRules as k, joinURL as l, getResponseStatusText as m, getResponseStatus as n, useNitroApp as o, hasProtocol as p, defu as q, sanitizeStatusCode as r, setHeader as s, parseURL as t, useRuntimeConfig as u, decodePath as v, withQuery as w, isScriptProtocol as x, parseQuery as y, withTrailingSlash as z };
